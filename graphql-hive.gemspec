...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{"GraphQL Hive integration for `graphql-ruby`"}
  spec.description   = %q{"Monitor operations, inspect your queries and publish your GraphQL schema with GraphQL Hive"}
